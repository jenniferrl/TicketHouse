...
@section('content')
    <div class="container" style="min-height: 550px; padding-bottom:100px; padding-top:100px;">
        ...
        <div class="row d-flex justify-content-between">
            ...
            <div class="col-md-5">
                <form class="d-flex" method="GET" action="/history/success/search">
                    <input class="form-control me-1" size="10" name="keyword" type="search" placeholder="Cari nama tiket" value="{{ request()->input('keyword') }}" aria-label="Search">
